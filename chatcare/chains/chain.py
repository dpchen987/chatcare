...
def chain(query):
    ...
    # QA with hnsw
        ...
        # 初始化插入向量
        if not (os.path.exists(params.hnsw_kb_index_file) and os.path.exists(params.hnsw_kb_text_file)):
            ...
            kbs.insert_kb(embedding_init, data_init)
        result = kbs.query_kb(embedding, k=1)
